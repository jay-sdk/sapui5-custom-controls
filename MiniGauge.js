...
sap.ui.core.Control.extend("sap.jaysdk.MiniGauge", {
	...
	createGauges : function() {
		...
		var oMiniGaugeFlexBox = new sap.m.FlexBox({height:"120px",alignItems:sap.m.FlexAlignItems.Center});		
	...
	onAfterRendering: function(){
		...
		var chart = vis.append("svg").attr("width", 600).attr("height", 120).style("background-color","white").selectAll("path").data(data).enter()
			.append("g").attr("transform", function(d, i){ return "translate(" + ((i*120)+60) + ",55)"});
		chart.append("path")
			.attr("d", bgarc)
			.style("fill", "#EEEEEE")
